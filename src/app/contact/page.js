    ...
    <div>
      ...
      <main className="p-4">
        ...
        <div className="md:p-12 p-5 flex flex-col md:flex-row">
          ...
          >
            <h3 className="font-bold text-2xl mb-5">Online Inquiry</h3>
            <form
            ...
            >
              ...
              <button
                type="submit"
                className="p-2 bg-blue-500 text-white rounded md:w-auto w-full"
              >
                Submit
              </button>
            </form>
          ...
          <div
            id="col-2"
            className="basis-1/2 flex flex-col items-center order-2 md:mt-0 mt-5"
          >
            <h3 className="font-bold text-2xl mb-5">Contact Details</h3>
            <p>morseaccountingITS@gmail.com</p>
            <p>207-487-5099</p>
            <h4 className="font-bold text-xl mt-5 mb-5">Business Address</h4>
            <p>11 North Road, Detroit, ME</p>
          </div>
        </div>
      </main>
    </div>
